      ...
      <div className="posts-list">
        ...
        <div className="post">
          ...
          <div className="post-content">
            ...
            <p className="post-summary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique voluptates explicabo qui dolorum temporibus iusto doloremque! Soluta minima est dolores explicabo non expedita illum neque, perspiciatis animi tenetur rerum esse nesciunt aperiam velit magnam!</p>
          </div>
        </div>
